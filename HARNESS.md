...
**현재 상태 (2026-06-01):** Flyway V229. BUILD SUCCESSFUL. security-lint 18/18 PASS. 512개 테스트 전 통과. 최근 완료: V228 허용 이메일 일반/영업 탭 분리, V229 개인정보 동의 일시·버전 DB 저장, SalesMemberServiceTest 20개 추가(만료 문서 필터링 회귀 보호 포함).
