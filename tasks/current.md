...
- [x] 통합 워크스페이스(/workspace) 신설 — WorkspaceController + workspace.html
...
## 건드리면 안 되는 파일
- `src/main/resources/db/migration/V1~V215.sql` — 기존 마이그레이션 절대 수정 금지
...
## 이전 세션에서 멈춘 곳
2026-05-27: 기능 개편 전체 완료. 회원가입·설정·폴더·인증서·통계·문서 최신화까지 마무리.
