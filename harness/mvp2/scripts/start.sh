...
cat <<EOF
=== eActive Resource Hub — MVP2 Stage $STAGE_ID ===

[프로젝트 SSOT — MVP2]
- 본 SSOT: $MVP_ROOT/docs/PROJECT_SPEC_MVP2.md  (MVP2 변경사항이 우선)
- 마이그레이션 가이드: $MVP_ROOT/docs/MIGRATION_FROM_MVP1.md
- MVP1 배경 SSOT: $WORKSPACE_ROOT/mvp1/docs/PROJECT_SPEC.md
- 핵심 제약 (MVP1과 동일):
